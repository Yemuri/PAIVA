...
-- AddForeignKey
ALTER TABLE `eventos` ADD CONSTRAINT `eventos_categoriaId_fkey` FOREIGN KEY (`categoriaId`) REFERENCES `categorias_eventos`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
