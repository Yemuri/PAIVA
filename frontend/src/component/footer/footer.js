    ...
    <div className="container-geral">
      <div className="colunas">
        ...
        <div className="devpor">
          <h6>
            Desenvolvido por{" "}
            <a onClick={abrirModal} className="fabrica-software">
              {" "}
              Fábrica de Software
            </a>
          </h6>
        ...
        >
          <div className="desenvolvedores">
            ...
            <a href="mailto: bruna.raissa2003@gmail.com">
              {" "}
            ...
            <a href="mailto: kaualimaonunes@gmail.com">
              {" "}
