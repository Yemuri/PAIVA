  ...
  return (
    <div className="mapa">
      <div className="endereco">
        <p className="rua">Rua: Santa Rita, nº 1-73 - Vila Camargo</p>
        <p className="cep">CEP: 17060-130 - Bauru/SP</p>
        <p className="tel">Telefone: +55 14 3526-5544</p>
        <p className="email">E-mail: teste@teste.com.br</p>
        <p className="horario">
          Horário de funcionamento: De segunda a sexta-feira das 8h às 12h e das
          13h às 17h
        </p>
      </div>
      <iframe
